...
<div>
    <h3 className="text-green-700 text-center mt-6 text-3xl">PKR = 90,00,000/=</h3>
</div>
<div className="flex justify-center">
       <Link href="/hondacivic"><button className="bg-blue-500 border-2 border-white text-black px-6 py-2 rounded mt-8">
        Back
       </button>
       </Link>
       </div>
